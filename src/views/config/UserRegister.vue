...
// Objeto Inicial Limpo
const defaultItem = {
  id: null,
  username: '',
  email: '',
  password: '',
  phone: '', // Adicionado para evitar o erro de undefined
  role: null,
  company: null,
  department: null
}
...
const save = async () => {
  try {
    ...
    alert("Erro ao salvar usuário. Verifique se os campos foram preenchidos corretamente.") 
  }
}
