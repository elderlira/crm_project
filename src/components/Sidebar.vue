...
>
      ...
      <div>
        <!-- Header -->
        <div class="flex items-center gap-3 pt-6 pb-4 px-4 border-b border-purple-600">
          ...
          <div v-if="isOpen">
            ...
            <div class="text-xs text-purple-400">CRM</div>
          </div>
        </div>
        ...
        <button
          @click="emit('toggle')"
          class="w-full p-3 hover:bg-purple-700 transition" :style="{backgroundColor: 'indigo'}"
        >
          ☰
        </button>
        ...
        <nav class="mt-4 space-y-2 px-2">
          <RouterLink
            to="/"
            class="flex items-center gap-3 p-3 rounded hover:bg-purple-700 transition"
          >
      ...
      <!-- RODAPÉ -->
      <div class="p-4 border-t border-purple-600 flex items-center gap-3 mt-auto">
        👤
        <div v-if="isOpen">
